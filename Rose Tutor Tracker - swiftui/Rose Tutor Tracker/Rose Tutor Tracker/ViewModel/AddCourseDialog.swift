//
//  AddCourseDialog.swift
//  Rose Tutor Tracker
//
//  Created by Elvis on 4/17/22.
//
// ALert wrapper from https://swiftuirecipes.com/blog/swiftui-alert-with-textfield
...
//        TutorViewModel.shared.tutor?.courses.append((textField?.text)!)
    })
  }
}
